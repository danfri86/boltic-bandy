...
$args['opt_name'] = 'boltic';

//Custom menu icon
//$args['menu_icon'] = '';

//Custom menu title for options page - default is "Options"
$args['menu_title'] = __('Tema inställningar', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Boltic temainställningar', 'nhp-opts');

//Custom page slug for options page (wp-admin/themes.php?page=***) - default is "nhp_theme_options"
$args['page_slug'] = 'boltic_theme_options';

//Custom page capability - default is set to "manage_options"
$args['page_cap'] = 'edit_private_pages';
...
$sections[] = array(
	...
	'title' => __('Allmänt', 'nhp-opts'),
	'desc' => __('<p class="description">Här kan vissa grundinställningar ändras.</p>', 'nhp-opts'),
	'fields' => array(
		array(
		...
		array(
			'id' => 'footer_info',
			'type' => 'info',
			'desc' => __('<p class="description">Footer</p>', 'nhp-opts')
		),
		array(
			'id' => 'footer_telefon',
			'type' => 'text',
			'title' => __('Telefonnummer', 'nhp-opts'),
			...
			'placeholder' => '0134-122122'
		),
		array(
			'id' => 'footer_epost',
			'type' => 'text',
			'title' => __('E-post', 'nhp-opts'),
			//'sub_desc' => __('This is a little space under the Field Title in the Options table, additonal info is good in here.', 'nhp-opts'),
			//'desc' => __('This is the description field, again good for additional info.', 'nhp-opts'),
			'validate' => 'email',
			//'msg' => 'custom error message',
			'placeholder' => 'info@kansliet.se'
		),
		array(
			'id' => 'footer_adress',
			'type' => 'text',
			'title' => __('Adress', 'nhp-opts'),
			//'sub_desc' => __('This is a little space under the Field Title in the Options table, additonal info is good in here.', 'nhp-opts'),
			//'desc' => __('This is the description field, again good for additional info.', 'nhp-opts'),
			//'validate' => 'email',
			//'msg' => 'custom error message',
			'placeholder' => 'Tingvalla isstadion'
		),
	)
);
					/*
					array(
						'id' => 'opt-slideshow-sek', //must be unique
						'type' => 'select',
						'title' => __('Antal sekunder', 'nhp-opts'),
						'sub_desc' => __('Hur många sekunder ska varje bild visas innan nästa bild visas?', 'nhp-opts'),
						'options' => array('1000' => '1 sek','2000' => '2 sek','3000' => '3 sek','4000' => '4 sek','5000' => '5 sek','6000' => '6 sek','7000' => '7 sek','8000' => '8 sek','9000' => '9 sek','10000' => '10 sek'),//Must provide key => value pairs for select options
						'std' => '4000' //This is a default value
						),
					array(
						'id' => 'opt-slideshow-paus',
						'type' => 'radio',
						'title' => __('Pausa på hover', 'nhp-opts'), 
						'sub_desc' => __('Ska bildspelet pausa när musen hålls över bilden?', 'nhp-opts'),
						'options' => array('true' => 'Ja','false' => 'Nej'),
						'std' => 'false'
						),
					array(
						'id' => '23',
						'type' => 'info',
						'desc' => __('<p class="description">Här nedanför kan du ändra den "Välkommen till AFAB AB" text som visas på framsidan.</p>', 'nhp-opts')
						),
					array(
						'id' => 'opt-valkommen',
						'type' => 'editor',
						'title' => __('Innehåll', 'nhp-opts')
						)
					*/
