         ...
         <div class="container">
            ...
            <?php
   			$args = array(
   					...
   					'items_wrap'=>	'<ul>%3$s<li><a id="right-menu" href="#sidr" class="btn-mobile"><i class="fa fa-align-justify"></i></a><a id="btn-mobile-open"><i class="fa fa-align-justify"></i></a></li></ul>', // Tar bort ul id och class helt och hållet
   				);
   			wp_nav_menu( $args );
   			?>
         </div>
